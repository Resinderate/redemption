...
#ifndef SIMPLEMUDEXAMPLEHANDLER_H
#define SIMPLEMUDEXAMPLEHANDLER_H
...
namespace SimpleMUD
{
	...
	class ExampleHandler : public Telnet::handler
	{
	...
	public:
		...
		// ------------------------------------------------------------------------
		ExampleHandler(Connection<Telnet>& p_conn, player p_player)
			: thandler(p_conn)
		{
			m_player = p_player;
		}
